...
class RegisterForm(UserCreationForm):
    ...
    username = forms.CharField(max_length=200, label='Nom d\'utilisateur', widget=forms.TextInput(attrs={'class': 'form-control form-control-lg', 'placeholder':'Rida123'}),)
    ...
    first_name = forms.CharField(label='Prénom', max_length=50,
                                 widget=forms.TextInput(attrs={'class': 'form-control form-control-lg', 'placeholder' : 'Rida'}))
    last_name = forms.CharField(label='Nom de famille', max_length=50,
                                widget=forms.TextInput(attrs={'class': 'form-control form-control-lg', 'placeholder' : 'Messaoudene'}))
